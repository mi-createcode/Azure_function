# (Azure_function) Solar Power Generation Prediction - Real-time Data Pipeline
...
1. Clone the repository:git clone https://github.com/mi-createcode/Azure_function.git
...
func start
Deploy to Azure and test using:
